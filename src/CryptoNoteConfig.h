...
// Copyright (c) 2018, The Highest Craft Developers
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x5509f;
...
/* The index in the FORK_HEIGHTS array that this version of the software will
   support. For example, if CURRENT_FORK_INDEX is 1, this version of the
   software will support the fork at 2,000,000 blocks.
...
const char     CRYPTONOTE_NAME[]                             = "Chroncoin";
...
const int      P2P_DEFAULT_PORT                              =  3516;
const int      RPC_DEFAULT_PORT                              =  3517;
...
{
    {  0x3a, 0x5b, 0x7c, 0xcf, 0x55, 0x57, 0x31, 0x69, 0xf8, 0x81, 0xb4, 0xc6, 0xd2, 0x33, 0xe7  }
};

const char* const SEED_NODES[] = {
  "174.138.68.141:11897", //rock - need to find multiple servers
